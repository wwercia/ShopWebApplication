...
public class ClientDAO extends BaseDao {
    ...
    public Client getClientDataByClientEmail(String emaill) {
    ...
    public void updateClientNameAndSurname(String name, String surname, int clientId) {
    ...
    public void updatePassword(String newPassword, int clientId) {
